<?php 
    ...
    $id=$_GET['id'];
    // var_dump($id);
    $sql="SELECT * FROM item WHERE id = :value1";
    ...
    $sqlBrand = 'SELECT * FROM brand ORDER BY name';
    $stmtBrand = $conn->prepare($sqlBrand);
    $stmtBrand->execute();
    $brands = $stmtBrand->fetchAll();

    $sqlSub = 'SELECT * FROM subcategory ORDER BY name';
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <div class="tile-body">
                    <form action="item_update.php" method="POST" enctype="multipart/form-data" class="ml-3">
                      ...
                      <input type="hidden" name="oldphoto" value="<?= $items['photo']?>">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                          ...
                          <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab"><input type="file"  id="profile" name="newphoto"></div>
