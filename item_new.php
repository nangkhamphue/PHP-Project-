	        ...
	        <div class="card-body">
	            <form action="item_add.php" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group row">
				    	...
				    	<div class="col-sm-10">
				      		<input type="text" class="form-control" id="categoryName" placeholder="Enter Item Name" name="name">
				    	</div>
					</div>
					...
					<div class="form-group row">
                        <label for="name_id" class="col-sm-2 col-form-label"> Item Code </label>
                           <div class="col-sm-10">
                             <input type="text" class="form-control" id="name_id" name="code"  placeholder="Enter Item Code">
                           </div>
                    </div>
					...
					<div class="form-group row">
				    	...
				    	<div class="col-sm-10">
				      		<select class="form-control select2 form-control-lg" name="category">
								...
								<?php 
									$sql="SELECT * from subcategory ORDER BY name ASC";
						        	$stmt=$pdo->prepare($sql);
						        	$stmt->execute();
						        	$rows= $stmt->fetchAll();
